...
"""
GPU0训练脚本 - 6种PII
BANK_CARD, PASSPORT, HK_MACAU_PASS, POSTAL_CODE, IP_ADDRESS, MAC_ADDRESS
"""
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # 强制使用GPU0
...
print("🚀 GPU0 训练任务启动")
print("="*70)
print(f"训练PII类型: BANK_CARD, PASSPORT, HK_MACAU_PASS, POSTAL_CODE, IP_ADDRESS, MAC_ADDRESS")
print(f"GPU: 0")
...
TRAIN_DATA = "data/gpu0_train.jsonl"
OUTPUT_DIR = "models/pii_11new_gpu0"
MAX_SEQ_LENGTH = 512
LORA_R = 16
LORA_ALPHA = 32
BATCH_SIZE = 12
